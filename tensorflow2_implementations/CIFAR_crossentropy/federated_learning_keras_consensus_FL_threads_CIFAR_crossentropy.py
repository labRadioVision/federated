...
parser.add_argument('-target', default=1.2, help="sets the target loss to stop federation", type=float)
...
parser.add_argument('-modelselection', default=0, help="sets the model: 0 for vgg1", type=int)
