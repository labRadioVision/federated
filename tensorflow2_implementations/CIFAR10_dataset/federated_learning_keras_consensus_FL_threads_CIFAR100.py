...
parser.add_argument('-K', default=120, help="sets the number of network devices", type=int)
...
parser.add_argument('-random_data_distribution', default=1, help=" set 0 for fixed distribution, 1 for time-varying", type=int)
