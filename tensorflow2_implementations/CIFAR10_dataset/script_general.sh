...
python federated_learning_keras_PS_CIFAR100.py -PS 0 -consensus 0 -K 100 -run 0 -target 0.5
...
python federated_learning_keras_PS_CIFAR100.py -PS 1 -consensus 0 -K 100 -Ka 40 -run 0 -target 0.5
...
#python federated_learning_keras_PS_CIFAR100.py -PS 1 -consensus 0 -K 100 -Ka 40 -run 1 -target 1
...
#python federated_learning_keras_consensus_FL_CIFAR100.py -PS 0 -consensus 1 -K 100 -N 1 -Ka_consensus 40 -run 0 -target 0.5
...
#python federated_learning_keras_consensus_FL_CIFAR100.py -PS 0 -consensus 1 -K 100 -N 1 -Ka_consensus 40 -run 1 -target 1
...
#python federated_learning_keras_low_power_PS_CIFAR100.py -PS 1 -consensus 0 -K 100 -Ka 40 -run 0 -target 0.5
...
#python federated_learning_keras_low_power_PS_CIFAR100.py -PS 1 -consensus 0 -K 100 -Ka 40 -run 1 -target 1
