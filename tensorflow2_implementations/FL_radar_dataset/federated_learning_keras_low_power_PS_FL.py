...
parser.add_argument('-Ka', default=9, help="sets the number of active devices per round in FA (<= K)", type=int)
parser.add_argument('-N', default=1, help="sets the max. number of neighbors per device per round in CFA", type=int)
parser.add_argument('-Ka_consensus', default=9, help="sets the number of active devices for consensus", type=int)
